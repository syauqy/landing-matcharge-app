...
export default function LakuPage() {
  ...
  const introduction =
    "Your birth Weton, Monday Kliwon, along with its associated cycles like your Laku Aras Kembang and Rakam Macan Ketawan, offers profound insights into your natural talents, professional predispositions, and the environment where you are most likely to thrive in your career. These elements reveal not just what you are good at, but also the energetic predispositions that shape your work ethic, leadership style, and potential challenges, guiding you towards a path where your efforts feel most aligned and productive.";
      ...
      try {
        ...
        if (existingReading) {
          ...
          try {
            ...
            const response = await fetch("/api/readings/work/work-pro", {
              method: "POST",
              headers: {
