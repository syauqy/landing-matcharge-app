...
export default function SadwaraPage() {
  ...
  return (
    <div className="min-h-screen bg-base-100 text-base-content font-sans">
      ...
      <main className="p-5 bg-base-100 md:p-6 max-w-3xl mx-auto space-y-6 pb-16">
        <div>
          <h2 className="text-xl font-semibold text-left">Sadwara</h2>
          <p className="text-sm text-gray-700 mb-2">
            Explore the subtle behavioral tendencies influenced by the six-day
            Pawukon cycle.
          </p>
        </div>
        <section>
