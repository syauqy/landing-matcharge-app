...
export default function ConciousCoinPage() {
  ...
  const introduction = profileData?.weton
    ? `Javanese calendrical systems, particularly the Wuku cycles and the daily Weton movements, offer unique insights into the ebb and flow of financial energies. For you, your ${profileData?.weton?.weton_en} Weton and Wuku ${profileData?.wuku?.name} understanding these rhythms can guide you in choosing the most auspicious timing for your financial endeavours. This ancient wisdom helps you align your actions with the natural energetic currents, enhancing your potential for prosperity.`
    : "";
