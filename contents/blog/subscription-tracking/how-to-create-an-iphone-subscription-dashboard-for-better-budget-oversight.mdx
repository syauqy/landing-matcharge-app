...
- **[Forgotten Subscriptions](/blog/subscription-glossary#forgotten-subscription):** That [free trial](/blog/subscription-glossary#free-trial) you meant to cancel but forgot.
- **[Duplicate Subscriptions](/blog/subscription-glossary#duplicate-subscriptions):** Paying for two streaming platforms that offer similar content.
- **[Underutilized Apps](/blog/subscription-glossary#underutilized-subscription):** Subscribing to a premium app you barely use.
...
- **Conditional Formatting:** Most spreadsheet apps allow conditional formatting. You can highlight rows where the "Next Renewal Date" is within the next 7-14 days. This gives you a visual alert for upcoming renewals without needing separate Reminders for every single item.
  - _Example in Google Sheets:_ Select the 'Next Renewal Date' column, go to Format > Conditional formatting. Set "Date is before" and choose "exact date" or "today/tomorrow/in the past week" and apply a specific color fill. You can then add another rule for "Date is after" a specific relative date for future weeks.
...
For category-specific guidance on managing different subscription types, check out our guides on [managing fitness app subscriptions](/blog/managing-fitness-app-subscriptions-on-iphone-for-optimal-health-spending), [mobile game subscriptions](/blog/how-to-manage-mobile-game-subscriptions-on-your-iphone-for-better-playtime-value), and [educational app subscriptions](/blog/how-to-monitor-educational-app-subscriptions-on-your-iphone-for-learning-goals).
