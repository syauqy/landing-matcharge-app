---
title: "How to Find Subscriptions Not Listed in Apple Settings (Step-by-Step)"
slug: manual-iphone-subscription-tracking-for-non-app-store-services
description: "Some subscriptions (Netflix, Spotify, etc.) don't show in Apple Settings. Learn how to find and manage them all from your iPhone."
date: 2026-02-25
...
## How to Find Subscriptions Not Listed in Apple Settings (Step-by-Step)

Apple Settings shows you App Store subscriptions, but not services like Netflix, Spotify, Adobe, or Dropbox.

These subscriptions are billed directly by the company, so they don't appear in Apple's subscription management screen. That makes them easy to forget about—but you can still find them all in one place.

Here's how to locate every subscription on your iPhone, including the ones Apple doesn't show you.
...
Beyond Reminders, consider adding important subscription renewal dates (especially annual ones) to your iPhone's native Calendar app. Set an alert a week or two in advance. This serves as an additional failsafe, prompting you to review before the charge hits. For those interested in more sophisticated automation, you can also explore [streamlining subscription management with automation shortcuts](/blog/streamlining-subscription-management-on-iphone-with-automation-shortcuts).
