...
4.  **Add Actions:**
    ...
    - Search for **"Repeat with Each."** Drag the "Repeat with Each" action _after_ your "Text" action and ensure it processes the "Reminders" magic variable from the "Find Reminders" action.
